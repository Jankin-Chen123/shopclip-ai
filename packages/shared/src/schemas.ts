...
export const SmartEditSegmentOverrideSchema = z.object({
  ...
  captionTextColor: z.string().regex(/^#[0-9a-fA-F]{6}$/u).optional(),
  captionTextFontSize: z.number().min(12).max(72).optional(),
  captionTextPositionYPercent: z.number().min(8).max(92).optional(),
